		 ...
		 $.ajax({
				...
				success : function(data) {
					...
					for(var i=0;i<list.length;i++){
						...
						"<td class='td_modi'>&nbsp;"+
						"<a href='/flowerWorld_v2/userAdmin/toUpdateUserAdmin2.do?uId="+list[i].u_id+"'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+
	...
	<div class="zl-header">
		<div class="zl-hd w1200">
			...
			<p class="hd-p2 f-r">
				...
				<span>|</span> <a
					href="/flowerWorld_v2/personalCenter/toPersonalCenter.do">修改个人信息</a><span>|</span>
			...
			<div id="templatemo_main">
				...
				<div id="main">
					<div class="search_add" style="font-size: 10px; color: #020528">
						<div>
							...
							<c:forEach items="${roles }" var="roles">
								<a id="subBtn" href="javascript:;"
									...
									${roles.rName } </a>
								<!-- 
									<a href="<%=basePath%>role/toUpdate.do?rId=${roles.rId}"> <input
										type="submit" value="修改" style="color: #fff; background: #73B52D;border: none"></a>
									<a href="<%=basePath%>role/deleteRole.do?rId=${roles.rId }">
										<input type="submit" value="删除" style="color: #fff; background: #73B52D;border: none" />
									</a>
									 -->
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</c:forEach>
						...
						<a href="findByUserAndRoleAll.do"> <input type="button"
							value="超级权限" class="btn_add" />
						</a>
					</div>
					<div id="data">
