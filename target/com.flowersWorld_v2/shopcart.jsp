...
<body>
        ...
        <tbody>  
            ...
            <c:if test="${!empty ShopCartList }">  
                <c:forEach items="${ShopCartList}" var="ShopCartList" varStatus="status">  
                    ...
                    <tr> 
                    		<td><input name="chen" checked="checked" type="checkbox" id="car${ShopCartList.carId }" value="${ShopCartList.carId }" onclick="ssa();"/></td>
    ...
    <a href="/flowerWorld_v2/to/findAuth.do"><h3>历史记录</h3></a>
