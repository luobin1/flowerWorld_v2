		...
		<div class="zl-hd w1200">
			...
			<p class="hd-p2 f-r">
				<c:if test="${user!=null }">
					...
					<c:if test="${user.r_id==1 || user.r_id==2}">
						<span>|</span><a href="/flowerWorld_v2/flower/loadAdminIndex.do">进入后台管理</a>
					</c:if>
				</c:if>
				<c:if test="${user==null }">
				...
				<div id="templatemo_menu" class="ddsmoothmenu">
					...
					<div id="templatemo_search">
							<input type="text" value="搜索" name="keyword" id="keyword"
								...
								type="button" name="Search"  onclick="findSome();" alt="Search"
		...
		<div id="templatemo_main_wrapper">
			<div id="templatemo_main">
				...
				<div id="content2" style="width: 700px;" class="right">
					...
					<div id="flowerList"  class="flowerList"></div>
					<div id="pageIndex" class="pageIndex" style=" width: 100%;height:50px;float: right;"></div>
				...
				<div id="content" class="right">
					...
					<c:forEach items="${flowers }" var="flower">
						<div class="product_box">
							<a
								href="/flowerWorld_v2/flower/findFlowerById.do?flowerId=${flower.flowerId }"><img
							...
							<p class="add_to_cart">
								<a
									href="/flowerWorld_v2/flower/findFlowerById.do?flowerId=${flower.flowerId }">查看详情</a> <a
									href="/flowerWorld_v2/to/addShopCart.do?flower_id=${flower.flowerId }">加入购物车</a>
							</p>
						</div>
					</c:forEach>
					</div>
					...
					<div id="limit-div">
						...
						<c:if test="${pageNumber>1 }">
							<div style="float: left;">
								<a
									href="/flowerWorld_v2/flower/getFlowers.do?pageNumber=${pageNumber-1 }"
						...
						<div style="float: left; width: 100px;" align="center">
							<c:forEach begin="1" end="${totalPage }" var="n">
								...
								<c:if test="${pageNumber!=n }">
									<a class="limit-a2"
										href="/flowerWorld_v2/flower/getFlowers.do?pageNumber=${n }"
	...
	<div class="footer-box">
		<ul class="footer-info1 w1200">
			...
			<li>
				...
				<h3>
					<a href="/flowerWorld_v2/flower/regist.do">注册有礼</a>
				</h3>
				<P>随时随地注册有大礼包</P>
			</li>
			<li>
