		...
		<div id="templatemo_main_wrapper">
			<div id="templatemo_main">
				...
				<div id="content" class="right">
					...
					<div class="member f-r"   style="width: 700px;border: 0px;">
						<div class="mem-info1">
							<div class="title">
								<h3>会员积分</h3>
							</div>
							<div class="mem-con1">
								<dl class="f-l">
									<dt>
										<a href="#"><img src="../liiy/images/data-tu2.gif" /></a>
									</dt>
									<dd>
										<a href="toPersonalCenter.do">${user.u_nname}</a> <a href="toPersonalCenter.do">${user.u_phone }</a>
									</dd>
									<div style="clear: both;"></div>
								</dl>
								<ul class="f-l">
									<li>
										<p>其他积分</p> <span>${score.s_integral }</span>
									</li>
									<li>
										<p>其他积分</p> <span>${score.s_integral }</span>
									</li>
								...
								<a href="/flowerWorld_v2/flower/getFlowers.do" class="duihuan f-l">兑换超值商品或参加活动</a>
								<div style="clear: both;"></div>
							</div>
						</div>
						<div class="mem-info2">
							...
							<div class="mem-con2">
								<dl hpjf="gmsp">
									<dt>
										<h3>
											购买商品获得共<span>${score.s_integral }</span>
										</h3>
										<p>您可以通过购物下单获取积分</p>
									</dt>
									<dd>
										<a href="/flowerWorld_v2/flower/getFlowers.do">去商城购物</a>
									</dd>
									<div style="clear: both;"></div>
								</dl>
