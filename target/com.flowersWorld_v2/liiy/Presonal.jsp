		...
		<div id="templatemo_main_wrapper">
			<div id="templatemo_main">
				...
				<div id="content" class="right" >
					<div class="personal-r f-r"  style="width: 710px;border: 0px;">
							...
							<div class="personal-right">
								...
								<div class="data-con">
									...
									<div class="dt1">
										...
										<input type="text" placeholder="RH了" name="u_nname"
											value="${user.u_nname }" />
										<div style="clear: both;"></div>
									</div>
									<div class="dt1">
										<p class="dt-p f-l">用户名：</p>
										<input type="text" name="u_rname" value="${user.u_rname }" />
										<div style="clear: both;"></div>
									</div>
									<div class="dt1 dt3">
									...
									<div class="dt1">
										...
										<input type="text" name="u_mail" value="${user.u_mail }" />
										<div style="clear: both;"></div>
									</div>
									<button id="submit" class="btn-pst">保存</button>
								</div>
							</div>
						</form>
					</div>
