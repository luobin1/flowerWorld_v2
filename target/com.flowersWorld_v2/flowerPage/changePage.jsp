...
<div id="templatemo_header_wsp">
	<div id="templatemo_header" class="header_subpage">
    	<div id="site_title"><a href="http://www.mycodes.net/" title="花花世界">花花世界</a></div>
        <div id="templatemo_menu" class="ddsmoothmenu">
            <ul>
                <li><a href="/flowerWorld_v2/flower/loadAdminIndex.do" class="selected">首页</a></li>
                ...
                <li><a href="/flowerWorld_v2/adminContact.jsp" target="_blank">在线系统</a></li>
        ...
        <a href="#" title="免费的图像"  class="site_repeat" ><img src="/flowerWorld_v2/images/top_repeat.png" title="免费的图像"  /></a><!-- end of templatemo_menu -->
...
<div id="templatemo_main">
	<div id="sidebar" class="left">
        ...
        <div class="sidebar_box"><span class="bottom"></span>
            ...
            <div class="content special"> 
                <img src="/flowerWorld_v2/images/templatemo_image_01.jpg" alt="Flowers" />
        ...
        function uploadimg(flowerId){
        	
        	$.ajax({
   				type : "POST",
   			    url : "/flowerWorld_v2/img/upload.do",
   			    data : {
   			        'img' :$(".image").attr("src"),
   			        'flowerId' : flowerId
   			    },
    ...
    <div class="content_half left form_field">
        	<img  id="image" class="image" src="${flower.flowerUrl1}" style="width: 200px;height: 200px;">
        	<input type="file" onchange="gen_base64(this);">
        	<button onclick="uploadimg(${flower.flowerId })">修改图片</button>
        	<span id="suc-msg"></span>
    	 <form action="/flowerWorld_v2/flower/changeFlowerInfo.do" method="post" enctype="multipart/form-data">
        	<br>
        	<input type="hidden" value="${flower.flowerId }" name="flowerId">
        	名称:<input value="${flower.flowerName }" name="flowerName" maxlength="40"><br>
        	类型: <select id="flowerTypeId" name="flowerTypeId">
        						<c:forEach items="${flowerTypes}" var="flowerType">
        							<option value="${flowerType.ftypeId }" <c:if test="${flower.flowerTypeId==flowerType.ftypeId}">selected</c:if>>${flowerType.ftypeName }</option>
        						</c:forEach>
							</select>
							<input type="hidden" value="1" >
							<br><br>
        	材质:<input value="${flower.material }" name="material" maxlength="40"><br>
        	包装:<input value="${flower.packing }" name="packing" maxlength="40"><br>
        	花语:<input value="${flower.flowerLanguage }" name="flowerLanguage" maxlength="40"><br>
        	附送:<input value="${flower.gifts }" name="gifts" maxlength="40"><br>
        	配送:<input value="${flower.distribution }" name="distribution" maxlength="40"><br>
        	价格:<input id="price" onblur="checkDouble(this.value,${flower.price });"  value="${flower.price }" name="price" maxlength="40">&nbsp;元<span style="color: red;" id="doubleErr"></span><br>
        	<input type="submit" value="修 改">&nbsp;
        	<input type="reset" value="重 置">
        	<span style="color: red;">${remsg }</span>
        </form>
        </div>
    </div>
...
<div id="templatemo_footer">
	...
	<div class="footer_right">
		<p><a href="/flowerWorld_v2/index.html">Home</a> | <a href="/flowerWorld_v2/products.html">Products</a> | <a href="/flowerWorld_v2/about.html">About</a> | <a href="/flowerWorld_v2/faqsAdmin.jsp">FAQs</a> | <a href="/flowerWorld_v2/checkout.html">Checkout</a> | <a href="/flowerWorld_v2/contact.html">Contact</a></p>
