...
//		$("[xgdz2] .dz-left p").text(address.a_name);
//		$("[xgdz2] .dz-right p").text(address.a_name);
//		$("[xgdz2] .tc-con2 li .textarea1").val(address.a_name);
//		$("[xgdz2] .tc-con2 li .shxm").val(address.a_name);
//		$("[xgdz2] .tc-con2 li .lxdh").val(address.a_name);
//	});
//	
