...
function deletes(){
    ...
    $.ajax({
        ...
        success:function(data){
            location.href="myProductPage.do";
        },
        error:function(data){
			...
			<div id="templatemo_main">
				...
				<div id="content" class="right">
					<div class="personal-r f-r">
						<div class="personal-right" style="width: 75%; margin-left: 263px;">
							<div>
								<div style="width: 85%; float: left;">
									<h3>
										<a href="myProductPage.do">消息中心列表 </a> < ${message.n_theme}
									</h3>
								</div>
								<div>
									<a href="myProductPage.do" style="font-size: 25px;">返回</a>
								</div>
							</div>
							<div class="pcm-con">
								<div class="pcm-top">
									<h2 style="color: #fff;">${message.n_theme}</h2>
									<p class="time" style="color: #fff;">${message.n_time}</p>
									<p class="rq">
										<span style="color: #fff;">${message.n_time}</span > <span style="color: #e79e05;">发件人： ${usernname}</span>
									</p>
								</div>
								<div class="pcm-info"
									style="border: 1px ridge; width: out; height: 300px; font-size: 25pt; padding: 15px;">
									${message.n_info}</div>
							</div>
							<div style="float: right;margin-top: 20px;">
									<input
										style="width: 100px; height: 40px; font-size: 25px; padding: 5px; margin: 2px;color: #e79e05;"
										type="button" value="刪除" onclick="deletes()" />
								</div>
						</div>
					</div>
					<br />
