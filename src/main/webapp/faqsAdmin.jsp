...
<body>
 <div class="zl-header">
    	<div class="zl-hd w1200">
        	<p class="hd-p1 f-l">
            	<a>您好，欢迎来到我的花花世界</a><span>|</span>
                <a href="/flowerWorld_v2/role/findAllRole.do">别删掉</a>
            </p>
        	<p class="hd-p2 f-r">
                ...
                <a href="/flowerWorld_v2/loginOut.do">退出</a>
            </p>
        ...
        <div id="templatemo_menu" class="ddsmoothmenu">
            <ul>
                <li><a href="/flowerWorld_v2/flower/loadAdminIndex.do"
						...
						<li><a href="/flowerWorld_v2/userAdmin/findByUserAndRoleAll.do">用户管理</a></li>
