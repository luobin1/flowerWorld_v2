				...
				<div id="sidebar" class="left">
					...
					<div style="width: 400px; height: 500px">
						<form action="modify.do" method="post">
							<table>
								<tr
									style="font-weight: bold; color: black; background-color: #7fffd4;">
									<td>分类名称</td>
									<td>上级分类</td>
								</tr>
								<tr>
									<td><input type="hidden"
										id="ftypeId${flowerTypeService.ftypeId}" name="ftypeId"
										value="${flowerTypeService.ftypeId} " /> <input
										name="ftypeName" value="${flowerTypeService.ftypeName} " /></td>
									<td><select id="ftypeName" name="ftypeName">
											...
											<option selected="selected">${typeService.ftypeName}${superType}</option>
							...
							<input type="submit" value=" 保 存"
								style="margin-left: 900px; font-size: 20px" />
						</form>
					</div>
