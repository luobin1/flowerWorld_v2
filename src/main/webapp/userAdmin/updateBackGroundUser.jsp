	...
	<div id="templatemo_wrapper_sp">
			...
			<div id="templatemo_header" class="header_subpage">
				...
				<div id="templatemo_menu" class="ddsmoothmenu">
					<ul>
						...
						<li><a href="/flowerWorld_v2/about.html">个人信息</a></li>
		...
		<div id="templatemo_main_wrapper">
			<div id="templatemo_main">
				...
				<!-- 中间div方块 -->
				<div id="main">
					<form action="/flowerWorld_v2/userAdmin/updateUserAdmin.do" method="post">
						<div class="search_add" style="font-size: 15px; text-align:center; color: #020528">
							...
							<select id="rId" name="r_id" class="edge">
								<option value="2" <c:if test="${user.r_id==2}">selected</c:if>>ADMIN</option>
				...
				<div class="footer_right">
					<p>
						<a href="/flowerWorld_v2/flower/loadAdminIndex.do">首页</a> | <a
							href="/flowerWorld_v2/products.html">个人信息</a> | <a
